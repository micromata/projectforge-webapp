...
public class XmlStreamTest extends TestBase
{
  ...
  public void testWrite()
  {
    ...
    TestObject obj = create(null, "", null, null, null, "", Double.NaN, 0.0, XmlConstants.MAGIC_INT_NUMBER, XmlConstants.MAGIC_INT_NUMBER);
  ...
  public void testWriteReadProperties()
  {
    ...
    assertValues(obj, null, "", "Hurzel", "", null, "", Double.NaN, 0.0, XmlConstants.MAGIC_INT_NUMBER, XmlConstants.MAGIC_INT_NUMBER);
  ...
  private void assertValues(final TestObject obj, final String s1, final String s2, final String s3, final String s4, final String t1,
