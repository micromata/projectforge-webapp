...
public class UrlHelperTest
{
  ...
  public void removeJSessionId()
  {
    ...
    assertEquals("https://localhost:8443/ProjectForge/wa/timesheetEdit/id/325295",
        URLHelper
        .removeJSessionId("https://localhost:8443/ProjectForge/wa/timesheetEdit/id/325295;jsessionid=DF6F216F10DC6A27EBA0EB60A7254EAA"));
    assertEquals("https://localhost:8443/ProjectForge/wa/timesheetEdit/id/325295",
        URLHelper.removeJSessionId("https://localhost:8443/ProjectForge/wa/timesheetEdit/id/325295"));
    assertEquals("https://localhost:8443/?hurzel", URLHelper.removeJSessionId("https://localhost:8443/;jsessionid=376kjKJ224?hurzel"));
    assertEquals(
        "https://localhost:8443/ProjectForge/wa/?wicket:bookmarkablePage=:org.projectforge.web.timesheet.TimesheetMassUpdatePage",
        URLHelper
        .removeJSessionId("https://localhost:8443/ProjectForge/wa/;jsessionid=B2BE03E5838FDAFCE3ED1AE235A78878?wicket:bookmarkablePage=:org.projectforge.web.timesheet.TimesheetMassUpdatePage"));
    assertEquals("https://localhost:8443/timesheetList/date=6546576/store=false?hurzel",
        URLHelper.removeJSessionId("https://localhost:8443/timesheetList/date=6546576/store=false;jsessionid=376kjKJ224?hurzel"));
