...
public class MenuEntryConfigTest
{
  ...
  {
    final MenuEntryConfig menu = new MenuEntryConfig().addTranslation("de", "Anmelden").addTranslation("en_US", "Logon").addTranslation(
        "en_US_CA", "Asta la vista").setLabel("Login");
