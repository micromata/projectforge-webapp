...
public class SVGHelperTest
{
  ...
  public void append()
  {
    ...
    assertArrayEquals(new String[] { "1", "3", "vier"}, SVGHelper.append(new String[] { "1"}, new Object[] { 3, "vier"}));
    assertArrayEquals(new String[] { "1", "2", "3", "vier"}, SVGHelper.append(new String[] { "1", "2"}, new Object[] { 3, "vier"}));
  }
  ...
  public void prepend()
  {
    ...
    assertArrayEquals(new String[] { "1", "zwei", "3"}, SVGHelper.prepend(new String[] { "3"}, new Object[] { 1, "zwei"}));
    assertArrayEquals(new String[] { "1", "zwei", "3", "vier"}, SVGHelper.prepend(new String[] { "3", "vier"}, new Object[] { 1, "zwei"}));
  }
