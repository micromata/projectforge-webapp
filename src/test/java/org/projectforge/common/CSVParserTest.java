...
public class CSVParserTest
{
  ...
  {
    StringReader in = new StringReader("1.1, 1.2, 1.3\n2.1,2.2, 2.3\r\n3.1,3.2,3.3\n10.10.2009,\"Hurzel, Hurzel; \",,5");
    CSVParser parser = new CSVParser(in);
    parser.setCsvSeparatorChar(',');
    assertLine(parser.parseLine(), "1.1", "1.2", "1.3");
    assertLine(parser.parseLine(), "2.1", "2.2", "2.3");
    ...
    try {
      ...
      assertEquals(CSVParser.createMessage(CSVParser.ERROR_UNEXPECTED_CHARACTER_AFTER_QUOTATION_MARK, "", 1, 8), ex.getMessage());
    ...
    try {
      ...
      assertEquals(CSVParser.createMessage(CSVParser.ERROR_QUOTATIONMARK_MISSED_AT_END_OF_CELL, "", 1, 0), ex.getMessage());
    }
    ...
    try {
      ...
      assertEquals(CSVParser.createMessage(CSVParser.ERROR_UNEXPECTED_CHARACTER_AFTER_QUOTATION_MARK, "", 1, 9), ex.getMessage());
    }
  }
