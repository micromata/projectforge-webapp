...
public class CrmPlugin extends AbstractPlugin
{
  ...
  public static final String RESOURCE_BUNDLE_NAME = CrmPlugin.class.getPackage().getName() + ".CrmI18nResources";
  ...
  private static final Class< ? >[] PERSISTENT_ENTITIES = new Class< ? >[] { PersonalContactDO.class, ContactEntryDO.class, ContactDO.class};
