 ...
 */
public class TrainingAttendeeEditPage extends AbstractEditPage<TrainingAttendeeDO, TrainingAttendeeEditForm, TrainingAttendeeDao> implements ISelectCallerPage
{
   ...
   */
  @Override
  protected TrainingAttendeeEditForm newEditForm(final AbstractEditPage< ? , ? , ? > parentPage, final TrainingAttendeeDO data)
  {
