 ...
 * 
 */
public class CampaignListForm extends AbstractListForm<BaseSearchFilter, CampaignListPage>
{
  private static final long serialVersionUID = 6190615904711764514L;

  private static final org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(CampaignListForm.class);

  public CampaignListForm(final CampaignListPage parentPage)
  {
    super(parentPage);
  }
