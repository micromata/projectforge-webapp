...
public class TemplateCalendarProperties implements Serializable, Comparable<TemplateCalendarProperties>, Cloneable
{
  ...
  /**
   * Please note: Don't forget to call {@link TemplateEntry#setDirty()} after calling this method. Otherwise the set of visible calendars
   * may not up-to-date in the template entry.
   * @param visible
   * @return
   */
