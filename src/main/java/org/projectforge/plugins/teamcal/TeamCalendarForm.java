 ...
 * 
 */
public class TeamCalendarForm extends AbstractForm<TeamCalendarFilter, TeamCalendarPage>
{
      ...
      teamCalChoice.add(new AjaxFormComponentUpdatingBehavior("onChange") {
        ...
        protected void onUpdate(final AjaxRequestTarget target)
        {
          if (multipleTeamCalList.getAssignedItems().isEmpty() == false) {
            ...
            setResponsePage(TeamCalendarForm.this.getParentPage());
          }
        }
      });
  ...
  public TeamCalendarForm(final TeamCalendarPage parentPage)
  {
    super(parentPage);
  }

  public TeamCalendarFilter getFilter()
  {
    return filter;
  }

  void setFilter(final TeamCalendarFilter filter)
  {
    this.filter = filter;
  }
