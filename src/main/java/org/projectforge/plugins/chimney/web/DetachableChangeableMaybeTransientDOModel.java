 ...
 */
public class DetachableChangeableMaybeTransientDOModel<D extends ExtendedBaseDO< ? extends Integer>, B extends BaseDao<D>> extends LoadableDetachableModel<D>
{
  ...
  public DetachableChangeableMaybeTransientDOModel(final D object, final B baseDao)
  {
    super(object);
