...
public class TenantsProvider extends TextChoiceProvider<TenantDO>
{
  ...
  transient TenantsCache tenantsCache;

  transient TenantDao tenantDao;
  ...
  public List<String> getTenantNames(final String tenantIds)
  {
    ...
    for (final int id : ids) {
      final TenantDO tenant = getTenantsCache().getTenant(id);
      if (tenant != null) {
  ...
  public Collection<TenantDO> toChoices(final Collection<String> ids)
  {
    ...
    for (final String str : ids) {
      ...
      final TenantDO tenant = getTenantsCache().getTenant(tenantId);
      if (tenant != null) {
        list.add(tenant);
      }
    }
