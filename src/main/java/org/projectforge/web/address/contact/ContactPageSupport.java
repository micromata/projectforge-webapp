...
class ContactPageSupport implements Serializable
{
  ...
  public ContactPageSupport(final Form<ContactDO> form, final AbstractGridBuilder< ? > gridBuilder, final ContactDao contactDao,
  ...
  {
    return new FieldProperties<String>("address.website", new PropertyModel<String>(contact, "website")).setFieldType(FieldType.WEB_PAGE);
  }
  ...
  {
    return new FieldProperties<String>("email", new PropertyModel<String>(contact, "email")).setLabelDescription("contact.business")
  ...
  {
    return new FieldProperties<String>("email", new PropertyModel<String>(contact, "privateEmail")).setLabelDescription("contact.private")
        .setFieldType(FieldType.E_MAIL);
  }
  ...
  {
    return new FieldProperties<ContactStatus>("address.contactStatus", new PropertyModel<ContactStatus>(contact, "contactStatus"));
  }
  ...
  {
    return new FieldProperties<AddressStatus>("address.addressStatus", new PropertyModel<AddressStatus>(contact, "addressStatus"));
  }
  ...
  public FieldProperties<String> getPhoneNumberProperties(final String property, final String labelKey, final String labelDescriptionKey,
      final FieldType fieldType)
      {
    return new FieldProperties<String>(labelKey, new PropertyModel<String>(contact, property)).setLabelDescription(labelDescriptionKey)
