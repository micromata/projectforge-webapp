...
public class SpaceListPage extends AbstractListPage<SpaceListForm, SpaceDao, SpaceDO>
{
  ...
  public SpaceListPage(PageParameters parameters)
  {
  ...
  protected void init()
  {
    ...
    final CellItemListener<SpaceDO> cellItemListener = new CellItemListener<SpaceDO>() {
      public void populateItem(Item<ICellPopulator<SpaceDO>> item, String componentId, IModel<SpaceDO> rowModel)
      {
  ...
  @Override
  protected SpaceListForm newListForm(AbstractListPage< ? , ? , ? > parentPage)
  {
    return new SpaceListForm(this);
  }
  ...
  @Override
  protected IModel<SpaceDO> getModel(SpaceDO object)
  {
