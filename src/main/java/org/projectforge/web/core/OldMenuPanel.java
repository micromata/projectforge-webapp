 ...
 * 
 */
public class OldMenuPanel extends Panel
{
  public static final String USER_PREF_MENU_KEY = "menuTreeTable";

  private static final org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(OldMenuPanel.class);
