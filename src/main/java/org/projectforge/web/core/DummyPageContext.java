...
/**
 * Stripes actions beans uses the tupel request, response and DisplayTag / ProjectForge uses PageContext. This dummy PageContext is usefull
 * for the Stripes action beans to use the PageContext based classes.
