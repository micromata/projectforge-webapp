...
/**
 * Servlet Funktion: Upload eines Images in das Verzeichnis images. Wird benötigt um Bild vom FlexClient auf den Server zu laden.
 * 
 */
...
public class UploadImageFile extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet
{
  ...
  protected void doPost(final HttpServletRequest request, final HttpServletResponse response) throws ServletException, IOException
  {
     ...
     * request.getParameter("filename") + "." + request.getParameter("filetype"); } else { file = "image.png"; } } catch (Exception ex) {
     * log.warn("Failure reading the request"); log.warn(ex.getMessage(), ex); }
     */
  }
}
