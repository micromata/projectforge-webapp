...
public class TimesheetsICSExportDialog extends AbstractICSExportDialog
{
   ...
   * @param titleModel
   */
  public TimesheetsICSExportDialog(final String id, final IModel<String> titleModel)
  {
    super(id, titleModel);
  }
  ...
  {
    return CalendarFeed.getUrl4Timesheets(timesheetUserId != null ? timesheetUserId : ThreadLocalUserContext.getUserId());
  }
