...
public class HtmlRequestBuilder {
  ...
  private static HtmlHelper htmlHelper = new HtmlHelper();

  /**
   * Creates a new HtmlRequest and an empty collection of attributes.
   * TODO: c:url
  ...
  /**
   * Adds a parameter. For quick and dirty mode, the attribute
