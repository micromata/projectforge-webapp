...
/**
 */
@UrlBinding("/secure/access/AccessList.action")
@BaseAction(jspUrl = "/WEB-INF/jsp/access/accessList.jsp")
public class AccessListAction extends BaseListActionBean<BaseSearchFilter, AccessDao, GroupTaskAccessDO>
{
  private static final Logger log = Logger.getLogger(AccessListAction.class);

  public void setAccessDao(AccessDao addressDao)
  {
