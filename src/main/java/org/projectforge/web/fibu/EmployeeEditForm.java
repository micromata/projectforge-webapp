...
public class EmployeeEditForm extends AbstractEditForm<EmployeeDO, EmployeeEditPage>
{
  ...
  public EmployeeEditForm(EmployeeEditPage parentPage, EmployeeDO data)
  {
  ...
  protected void init()
  {
    ...
    final LabelValueChoiceRenderer<EmployeeStatus> statusChoiceRenderer = new LabelValueChoiceRenderer<EmployeeStatus>(this, EmployeeStatus
        .values());
