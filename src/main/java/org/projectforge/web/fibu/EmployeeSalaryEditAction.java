...
@StrictBinding
@UrlBinding("/secure/fibu/EmployeeSalaryEdit.action")
@BaseAction(jspUrl = "/WEB-INF/jsp/fibu/employeeSalaryEdit.jsp")
@BaseEditAction(listAction = EmployeeSalaryListAction.class)
