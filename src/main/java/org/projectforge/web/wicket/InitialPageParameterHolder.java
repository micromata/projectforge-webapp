...
class InitialPageParameterHolder
{
   ...
   * {@link AbstractListPage#getFilterObjectForInitialParameters}.</br> "pageSize|ps" represents a property which is set directly to the
   * data object: {@link AbstractSecuredPage#getDataObjectForInitialParameters()}.
