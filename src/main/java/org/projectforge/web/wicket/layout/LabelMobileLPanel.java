 ...
 * 
 */
public class LabelMobileLPanel extends AbstractLPanel
{
  ...
  /**
   * @see AbstractRenderer#createLabelLPanel(String, LayoutLength, String, Component)
   */
  LabelMobileLPanel(final String id, final LayoutLength length, final String label, final Component labelFor)
  {
  ...
  LabelMobileLPanel(final String id, final LayoutLength length, final Label label)
  {
    super(id, length);
    this.label = label;
    add(label);
  ...
  public LabelMobileLPanel setLabelFor(final Component component)
  {
