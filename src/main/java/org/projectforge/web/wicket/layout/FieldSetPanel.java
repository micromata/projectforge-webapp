...
public class FieldSetPanel extends Panel
{
  ...
  public FieldSetPanel(final String id)
  {
    super(id);
  }

  public FieldSetPanel(final String id, final String heading)
  {
    this(id);
    setHeading(heading);
  }

  public FieldSetPanel add(final GroupPanel groupPanel)
  {
