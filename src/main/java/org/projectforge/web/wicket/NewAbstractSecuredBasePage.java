 ...
 */
public abstract class NewAbstractSecuredBasePage extends NewAbstractUnsecureBasePage
{
  private static final org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(NewAbstractSecuredBasePage.class);
  ...
  public NewAbstractSecuredBasePage(final PageParameters parameters)
  {
    super(parameters);
  }
