...
public class ContractDao extends BaseDao<ContractDO>
{
   ...
   * @param contract is needed to check wether the contract does already exist or not. If already exist it will be assured that this
   *          contract has an unchanged number.
   */
  @SuppressWarnings("unchecked")
  @Transactional(readOnly = true, propagation = Propagation.SUPPORTS)
