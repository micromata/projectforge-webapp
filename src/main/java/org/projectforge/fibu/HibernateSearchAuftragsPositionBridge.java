...
/**
 * Bridge for hibernate search to search for order positions of form ###.## (&lt;order number&gt;.&lt;position number&gt>).
 * @author Kai Reinhard (k.reinhard@micromata.de)
 * 
 */
public class HibernateSearchAuftragsPositionBridge implements FieldBridge
{
  private static final org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(HibernateSearchAuftragsPositionBridge.class);
