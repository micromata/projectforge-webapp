...
public final class ClassicTokenizer extends Tokenizer {
   ...
   */
  public ClassicTokenizer(final Version matchVersion, final Reader input) {
    super();
   ...
   */
  public ClassicTokenizer(final Version matchVersion, final AttributeSource source, final Reader input) {
    super(source);
    init(input, matchVersion);
  }
   ...
   */
  public ClassicTokenizer(final Version matchVersion, final AttributeFactory factory, final Reader input) {
    super(factory);
    init(input, matchVersion);
  }
