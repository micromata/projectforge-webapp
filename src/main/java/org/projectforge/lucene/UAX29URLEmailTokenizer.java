...
public final class UAX29URLEmailTokenizer extends Tokenizer {
  ...
  private static int [] zzUnpackTrans() {
    final int [] result = new int[214182];
    int offset = 0;
   ...
   */
  public UAX29URLEmailTokenizer(final AttributeSource source, final Reader input) {
    super(source, input);
    zzReader = input;
  }
   ...
   * @param input The input reader
   */
  public UAX29URLEmailTokenizer(final AttributeFactory factory, final Reader input) {
    super(factory, input);
    zzReader = input;
  }
  ...
  public final void end() {
    // set final offset
    final int finalOffset = correctOffset(yychar + yylength());
   ...
   */
  private boolean populateAttributes(final String tokenType) {
   ...
   */
  public UAX29URLEmailTokenizer(final java.io.Reader in) {
    super(in);
    this.zzReader = in;
  }
   ...
   */
  public UAX29URLEmailTokenizer(final java.io.InputStream in) {
   ...
   */
  private final void yyreset(final java.io.Reader reader) {
    zzReader = reader;
    zzAtBOL  = true;
    zzAtEOF  = false;
    zzEOFDone = false;
