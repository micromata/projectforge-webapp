...
public final class StandardTokenizerImpl implements StandardTokenizerInterface {
  ...
  private static int [] zzUnpackTrans() {
    final int [] result = new int[10609];
    int offset = 0;
   ...
   */
  public StandardTokenizerImpl(final java.io.Reader in) {
    this.zzReader = in;
  }
   ...
   */
  public StandardTokenizerImpl(final java.io.InputStream in) {
